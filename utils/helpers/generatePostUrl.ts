...
export function generatePostUrl(
  ...
  const segments = [subjectSlug, classSlug, chapterSlug, topicSlug].filter(
    Boolean
  );
...
/**
 * S3 content key from URL.
 * Example:
 *   url: "math/class-8/chapter-3/integers"
 *   => md/math-class-8-chapter-3-integers.mdx
 */
